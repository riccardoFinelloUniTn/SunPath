...
/// Arena buffer backed by a single host-visible staging buffer with stable indices.
/// No GPU-only buffer — the staging buffer is directly accessible from shaders.
